...
export function readTurnstileEnvironment(env: NodeJS.ProcessEnv = process.env) {
  return {
    siteKey: env.TURNSTILE_SITE_KEY?.trim() || null,
    secretKey: env.TURNSTILE_SECRET_KEY?.trim() || null,
  };
}
...
export const appConfig = {
  ...
  turnstile: readTurnstileEnvironment(),
